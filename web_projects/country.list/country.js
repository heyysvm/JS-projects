...
function createAndAppendCountry(country) {
    ...
    countryEl.className = "w-[100%] m-auto flex bg-[#ebf2fc] rounded-[24px] mt-[15px] mb-[15px] p-[15px]"
    ...
    countryNameEl.classname = "text-[#183b56] font-[Roboto] text-[22px] font-bold mb-[8px]"
